...
const PROJECTS_CONTENT: Record<Language, ProjectsContent> = {
  es: {
    ...
    projects: [
      ...
      {
        title: 'CloudPoint',
        description: 'Plataforma de gestion empresarial desarrollada con Go y Angular TypeScript, desplegada en AWS y en produccion desde hace mas de 3 anos para centralizar operaciones clave desde movil.',
        features: [
          'Facturacion, presupuestos, albaranes y proformas desde una unica aplicacion',
          'Gestion centralizada de clientes, proveedores, inventario, stock y tarifas',
          'Control horario de empleados, calendario y gestion de citas',
          'Despliegue en AWS con enfoque en escalabilidad, disponibilidad y operativa continua',
          'Numerosas integraciones para conectar distintas areas del negocio',
          'Arquitectura mantenida y evolucionada en produccion durante mas de 3 anos',
        ],
        ...
        stats: [
          ...
          { value: '3+ anos', label: 'En funcionamiento' },
          { value: '15+', label: 'Integraciones clave' },
        ],
      },
      {
        title: 'Taxco App',
    ...
    additionalProjects: [
      {
        ...
        description: 'Pagina web personal desarrollada en Angular con diseño moderno y responsive.',
  ...
  en: {
    ...
    projects: [
      ...
      {
        title: 'CloudPoint',
        description: 'Business management platform built with Go and Angular TypeScript, deployed on AWS and running in production for more than 3 years to centralize key operations from mobile devices.',
        features: [
          'Invoicing, quotes, delivery notes, and proformas from a single app',
          'Centralized management of clients, suppliers, inventory, stock, and pricing',
          'Employee time tracking, calendar workflows, and appointment management',
          'AWS deployment focused on scalability, availability, and reliable day-to-day operations',
          'Numerous integrations connecting multiple business areas in one workflow',
          'Production architecture maintained and evolved over more than 3 years',
        ],
        technologies: ['Go', 'Angular', 'TypeScript', 'AWS', 'REST API', 'Integrations'],
        demoUrl: 'https://apps.apple.com/es/app/cloudpoint/id6798285786',
        stats: [
          ...
          { value: '15+', label: 'Key integrations' },
        ],
      },
      {
        title: 'Taxco App',
