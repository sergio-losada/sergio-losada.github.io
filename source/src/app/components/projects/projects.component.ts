  ...
  es: {
    ...
    projects: [
      ...
      // },
      {
        ...
        company: 'CloudPoint',
        cssClass: 'company-logo-short',
        companyLogo: 'https://cloudpoint.es/assets/logo.png',
        description: 'Plataforma de gestion empresarial desarrollada con Go y Angular TypeScript, desplegada en AWS y en produccion desde hace mas de 3 años para centralizar operaciones clave desde movil.',
        features: [
          'Facturacion y presupuestos desde el movil',
          'Clientes, stock y tarifas centralizados',
          'Control horario y gestion de citas',
          'Integraciones para distintas areas del negocio',
          'Panel operativo simple y rapido',
        ],
        technologies: ['Go', 'Angular', 'TypeScript', 'AWS', 'REST API', 'Integrations'],
        mockupUrl: 'https://gestion.cloudpoint.es/assets/mockup-banner.png',
        demoUrl: 'https://apps.apple.com/es/app/cloudpoint/id6798285786',
        stats: [
          { value: '100+', label: 'Usuarios activos' },
          { value: '3+', label: 'Años en funcionamiento' },
  ...
  en: {
    ...
    projects: [
      ...
      // },
      {
        ...
        features: [
          'Mobile invoicing and quotes',
          'Centralized clients, stock, and pricing',
          'Time tracking and appointment management',
          'Integrations across key business workflows',
